...
function(a) {
	function b() {
        ...
        var pastTime = '2017-07-22 00:00:00:000';
        var pastDate = new Date(pastTime.replace(/-/g, '/'));
        var pastTimeStamp = pastDate.getTime();
		var tempTimeStamp = nowTimeStamp - pastTimeStamp;
		// var b = (new Date).getTime() - new Date(2017, 7, 22, 0, 0, 0).getTime(),
        var b = tempTimeStamp,
			c = b % 31104e6,
			d = c % 2592e6,
			e = d % 864e5,
	...
	function g() {
		document.addEventListener("keydown", function(a) {
			...
			document.title = document.hidden ? "Arvin's Site" : "Arvin's Site"
		})
	}
	...
	a("#next-page-for-init").bind("click", function() {
		...
		//clearTimeout(b), f(), b = setTimeout(function() {
		//	a("#v4-pre-loaded").addClass("hide"), e()
		//}, 1e3)
	}
}(jQuery);